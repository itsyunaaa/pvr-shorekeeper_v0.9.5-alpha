...
You are free to use, modify, and distribute my code. However, **any modifications or derivative works must also be open-sourced under the same GPL-3.0 license**. You cannot simply take my code, make it closed-source, and claim it as entirely your own creation. Proper attribution to me as the original developer is required.
